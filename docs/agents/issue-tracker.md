...
- Project number: `26`
- Project title: `Paste Image Next`
- Project URL: https://github.com/users/gvastethecreator/projects/26
- Local root: `.scratch/vscode-paste-image-next/`
...
- Spec: `.scratch/vscode-paste-image-next/spec.md` (`PRD.md` remains compatible).
- Ticket mirrors: `.scratch/vscode-paste-image-next/issues/<NN>-<slug>.md`. Never under `docs/`.
- Rejected requests: `.scratch/vscode-paste-image-next/out-of-scope/<concept>.md`.
...
GitHub project: https://github.com/users/gvastethecreator/projects/26
...
5. Add the Issue to Project `26` under `gvastethecreator`.
...
```powershell
gh issue view <number> -R gvastethecreator/vscode-paste-image-next --json number,title,state,body,labels,assignees,comments,updatedAt,url
gh project view 26 --owner gvastethecreator --format json
gh project field-list 26 --owner gvastethecreator --format json
gh project item-list 26 --owner gvastethecreator --limit 200 --format json --field Status
gh project item-add 26 --owner gvastethecreator --url <issue-url>
gh project item-edit 26 --owner gvastethecreator --url <issue-url> --field Status --value Todo
gh issue create -R gvastethecreator/vscode-paste-image-next --title <title> --body-file <path> --parent <parent-number> --blocked-by <number,number>
gh issue edit <issue-number> -R gvastethecreator/vscode-paste-image-next --parent <parent-number> --add-blocked-by <number>
```
